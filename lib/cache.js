...
async function buildRowsForExchange(ex) {
  ...
  return current.map((c) => {
    ...
    return {
      ...
      // signal independent of the coin's overall market-cap rank. Only Paradex
      // provides it for now; other exchanges' rows carry null until verified.
      openInterestUsd: c.openInterestUsd ?? null,
      price: c.price ?? null,
