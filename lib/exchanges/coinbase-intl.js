...
// Delisted instruments stay in /instruments indefinitely with a frozen, stale
// quote (predicted_funding/timestamp last updated whenever trading actually
// stopped, best_bid_size/best_ask_size at "0") — trading_state is the only
// field that actually flags that, so it has to be checked explicitly; the
// quote-data-present check alone isn't enough to catch these.
