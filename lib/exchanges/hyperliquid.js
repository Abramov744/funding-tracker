...
const RATE_LIMIT_RETRIES = 3; // fetchHistory fans out several requests per candidate across a
const RATE_LIMIT_BASE_DELAY_MS = 2000; // 5-minute refresh — 429s here are common enough to retry, not just fail
