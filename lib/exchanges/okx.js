...
// out one funding-rate lookup per instrument with bounded concurrency (same
// approach as the Crypto.com adapter) rather than the single request most of the
// other exchanges make. The per-symbol call also carries fundingTime and
// nextFundingTime, which lets us derive the real funding interval per instrument
// instead of assuming a fixed 8h for all of them.
